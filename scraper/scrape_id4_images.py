...
MIN_HEIGHT      = 300
MIN_COLORS      = 300
PROGRESS_FILE   = "progress_id4.json"  # separate from Ford Fusion progress
# ──────────────────────────────────────────────────────────────────────────────
...
VIEWS = {
    "front": [
        "Volkswagen ID.4 {year} front view photo",
        "VW ID4 {year} front exterior photograph",
        "Volkswagen ID4 {year} headlights front",
        "{year} VW ID.4 front bumper photo",
        "Volkswagen ID4 {year} front angle shot",
        "{year} VW ID4 nose front grille photo",
    ],
    "rear": [
        "Volkswagen ID.4 {year} rear view photo",
        "VW ID4 {year} back exterior photograph",
        "Volkswagen ID4 {year} taillights rear",
        "{year} VW ID.4 rear bumper photo",
        "Volkswagen ID4 {year} rear angle shot",
        "{year} VW ID4 trunk rear photo",
    ],
    "side": [
        "Volkswagen ID.4 {year} side view photo",
        "VW ID4 {year} side profile photograph",
        "Volkswagen ID4 {year} side exterior",
        "{year} VW ID.4 side shot",
        "Volkswagen ID4 {year} door side panel photo",
        "{year} VW ID4 lateral side view",
    ],
    "full_body": [
        "Volkswagen ID.4 {year} full body photo",
        "VW ID4 {year} full exterior photograph",
        "Volkswagen ID4 {year} whole car photo",
        "{year} VW ID.4 complete car shot",
        "Volkswagen ID4 {year} 3/4 view photo",
        "{year} VW ID4 listing photo exterior",
    ],
}
...
def scrape_view(year, group_name, view, good_folder, rejected_folder, progress):
    ...
    # Count already saved images for this view+year
    existing = [
